...
Mesure the cumulative length and range from multipoint annotation on a 3D images <br/>
Cumulative Length : summed distance between each point <br/>
Range : distance between first and last point <br/>
How to use : <br/>
